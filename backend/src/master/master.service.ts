...
export class MasterService {
  ...
  async updateInstitution(id: number, data: any) { return this.institutionRepo.update(id, data); }
  ...
  async updateCampus(id: number, data: any) { return this.campusRepo.update(id, data); }
  ...
  async updateDepartment(id: number, data: any) { return this.deptRepo.update(id, data); }
  ...
  async updateProgram(id: number, data: any) { return this.programRepo.update(id, data); }
  ...
  async updateYear(id: number, data: any) { return this.yearRepo.update(id, data); }
